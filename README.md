...
### 👉 Try it live: **<https://hugofara.github.io/graded-guitar/>**

The deploy is the public face of the project. It serves the full M1 corpus (1108 pieces), runs the M3 player in your browser, and stores your profile and library locally (no server, no signup — see [ADR 0012](./decisions/0012-m5-local-accounts.md)).

> **Status:** Pre-alpha. M0–M3 scaffolded; M4 (discovery feed) and M5 (local-only profiles) landed; M6 (closed beta) infrastructure in place pending advisor sign-off. See [`project-spec.md`](./project-spec.md) §7 for the milestone definitions.
